...
export class TeamService extends BaseService {
  ...
  public GetRole = (pageNumber: number, pageSize: number, searchKey: string, filterObj: any): any => {
    const requestURL = 'Authorization/GetRole';
    var requestBody;
    if (searchKey == null && filterObj == null) {
      requestBody = {
        pageNumber,
        pageSize,
      };  
  ...
  public GetAllTeam = (pageNumber: number, pageSize: number, searchKey: string, filterObj: any): any => {
    const requestBody = {
